...
from mlgame.gamedev.game_interface import GameResultState, GameStatus, PaiaGame
from mlgame.view.test_decorator import check_game_progress, check_game_result
from mlgame.view.view_model import (Scene, create_scene_progress_data,
                                    create_text_view_data)

from .game_object import (SERVE_BALL_ACTIONS, Ball, Brick, HardBrick, Platform,
                          PlatformAction)
...
class Arkanoid(PaiaGame):
    ...
    def _create_moves(self):
        ...
        self._platform = Platform((random.randint(0,160), 400), pygame.Rect(0, 0, 200, 500), self._group_move)
